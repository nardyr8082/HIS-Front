...
export class RolePageComponent implements OnInit {
  ...
  getRoles(filters = this.filters, sortColumn = 'fecha', sortDirection = 'desc', page = 1, pageSize = DEFAULT_PAGE_SIZE) {
    this.loading = true;
  ...
  onChangePage(page: PageEvent) {
    this.getRoles(this.filters, 'fecha', 'desc', page.pageIndex + 1, page.pageSize);
  }

  onChangeFilter(filters) {
    this.filters = filters;
    this.getRoles(filters, 'fecha', 'desc');
  }
