...
import {
  MailTemplateParamRoutingModule
} from './mail-template-param-routing.module';
import {
...
@NgModule({
  ...
  declarations: [MailTemplateParamTableComponent, DialogAddEditMailTemplateParamComponent],
  entryComponents: [DialogAddEditMailTemplateParamComponent],
})
export class MailTemplateParamModule {}
