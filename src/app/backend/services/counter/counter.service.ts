...
export class CounterService {
  url = environment.apiUrl + 'counter';
  urlId = environment.apiUrl + 'counter/:id';
  httpOptions = {};
  ...
  getCounter(data: any): Observable<any> {
