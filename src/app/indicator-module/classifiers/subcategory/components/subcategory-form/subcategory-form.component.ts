...
export class SubcategoryFormComponent implements OnInit, OnDestroy {
  ...
  constructor(public subcategoryService: SubcategoryService, public dialogRef: MatDialogRef<SubcategoryFormComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {}
