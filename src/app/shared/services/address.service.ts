...
export class AddressService {
  private apiEndpoint = `${environment.apiUrl}direccion`;
  ...
  getAddresses(filter: any, sortColumn: string, sortDirection: string, page: number, pageSize: number): Observable<ApiResponse<any>> {
